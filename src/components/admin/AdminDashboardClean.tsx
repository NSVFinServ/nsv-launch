...
const AdminDashboardClean = () => {
  ...
  const fetchAllData = async () => {
    try {
      ...
      const [
        ...
        fetch('http://localhost:5000/api/referrals', { headers }),
        fetch('http://localhost:5000/api/loan-applications', { headers }),
        fetch('http://localhost:5000/api/dashboard-stats', { headers }),
        fetch('http://localhost:5000/api/admin/reviews', { headers }),
        fetch('http://localhost:5000/api/admin/testimonial-videos', { headers }),
        fetch('http://localhost:5000/api/admin/events', { headers }),
        fetch('http://localhost:5000/api/admin/regulatory-updates', { headers }),
        fetch('http://localhost:5000/api/admin/eligibility', { headers })
      ]);
  ...
  const handleDeleteRegulatoryUpdate = async (id: number) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/admin/regulatory-updates/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const handleUpdateLoanApplicationStatus = async (id: number, status: 'pending' | 'approved' | 'rejected') => {
    try {
      const response = await fetch(`http://localhost:5000/api/admin/loan-applications/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleUpdateEligibilityStatus = async (id: number, status: 'pending' | 'reviewed' | 'contacted') => {
    try {
      const response = await fetch(`http://localhost:5000/api/admin/eligibility/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleDeleteVideo = async (id: number) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/admin/testimonial-videos/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const handleAddVideo = async (e: React.FormEvent) => {
    ...
    try {
      if (videoImage) {
        ...
        const response = await fetch('http://localhost:5000/api/admin/testimonial-videos/upload', {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${token}`
          },
        ...
        const response = await fetch('http://localhost:5000/api/admin/testimonial-videos', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
  ...
  const handleAddRegulatoryUpdate = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await fetch('http://localhost:5000/api/admin/regulatory-updates', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
